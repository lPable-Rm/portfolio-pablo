  ...
  return (
    <section className="projects-mobile-carousel" aria-label="Carrusel de proyectos">
      <div className="projects-mobile-carousel__stage">
        ...
        <article className="projects-mobile-card" aria-live="polite">
          <p className="projects-mobile-card__counter">
            GAME {String(activeIndex + 1).padStart(2, "0")} /{" "}
            {String(projects.length).padStart(2, "0")}
          </p>

          <div className="projects-mobile-card__media">
            <img
          ...
          <div className="projects-mobile-card__copy">
          ...
          <div
            className="projects-mobile-card__stack"
            aria-label={`Stack de ${activeProject.label}`}
          >
            {activeProject.stack.slice(0, 6).map((tech) => (
              <span key={tech}>{tech}</span>
            ))}
          </div>

          <p className="projects-mobile-card__status">
